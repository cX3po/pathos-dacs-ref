...
`vectors/canonical-form-v0.1.json` is a byte copy of `conformance/partner-kit/vectors.json`; its index records path, size, SHA-256, and origin. It includes the repository's JCS accept/reject corpus and NFC/NFD cases.
