...
| `discovery-registration.json` | Unsigned DACS-1 listing draft for the verify service; signed and anchored with `npm run listing-pub` at deploy | the listing publisher |
