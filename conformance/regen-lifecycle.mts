...
// §B.1 ClaimReference is the STRING "Scheme:Identifier" — the canonical wire form. (Our earlier
// #145 emit used the object form { scheme, identifier }; RB flagged it as a cross-impl divergence
// (#146) because bundleHash + signatures cover those bytes, so an object-form bundle wouldn't
// reproduce for a spec-conformant verifier. Re-emitting in string form.)
