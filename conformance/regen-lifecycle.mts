...
const happy = {
  ...
  dacsVersion: '0.1',
  description: 'Machine-regenerated by pathos-dacs-ref (real signatures/hashes), covering all five '
    + 'stages in current v0.1 spec shapes incl. a real signed DACS-3 AgreementDocument (§8.5). '
    + 'Passes both validate_conformance_vectors.py and validate_artifact_shapes.py (deep shape check) '
    + '— lifts the #133/D2 quarantine. (Deferred reference-impl convergence — ClaimReference/Listing/'
    + 'Settlement emitters — is documented in the PR and does not affect these spec wire-form vectors.)',
