...
export function generateVectors(): object {
  ...
  return {
    ...
    notes: {
      ...
      contentHash: "SHA-256 over UTF8(JCS(header)) || raw(iv) || raw(ciphertext) || raw(tag), where raw() is the unpadded-base64url decoding of the field (12 / variable / 16 bytes); the base64url strings are never hashed.",
    },
