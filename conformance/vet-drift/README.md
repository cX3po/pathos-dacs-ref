...
| `decision` (`pass`/`fail`/`indeterminate`) | ✅ | the verdict — must agree (NB: DACS-2 §7.5.1 lists a 4th `error` value; our impl uses 3 + rejects malformed pre-VerifyResult — a convergence point) |
