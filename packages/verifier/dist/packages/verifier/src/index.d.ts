 ...
 */
export { VERIFIER_API_VERSION, classifyBundle, exitCodeFor, indeterminateVerdict, isLoadError, loadBundleSource, normaliseV1Verdict, verifyDocument, } from '../../../src/lib/verify-document.js';
export type { BundleKind, BundleSource, LoadedBundle, VerifyDocumentOptions, VerifyDocumentResult, } from '../../../src/lib/verify-document.js';
...
export declare const PACKAGE_NAME = "@pathos-labs/dacs-verifier";
