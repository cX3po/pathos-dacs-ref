...
export interface ClaimReference {
    ...
    scheme: 'key' | 'cci-xm' | 'cci-web2' | 'cci-pqc' | 'cci-ud' | 'cci-nomis' | 'cci-humanpassport' | 'cci-ethos' | 'cci-tlsn' | 'cci' | 'evm-key' | 'sol-key' | 'did' | 'erc8004' | 'lei' | 'finra-crd' | 'sam-uei' | 'fedramp' | 'naics' | 'cmmc' | 'stor-cred';
...
export interface LegacyIdentityBundle {
    ...
    presentation: {
        ...
        signature?: string;
        claimSignatures?: Record<number, string>;
        sessionPubkey?: string;
        sessionAuthSig?: string;
    };
}
/**
 ...
 *  single-hash payload.)
 */
export type BundleHash = Uint8Array;
