...
export type SubstrateRequirement = 'sr-1-keyed-storage' | 'sr-2-anchored-storage' | 'sr-3-consensus-backed-proxy' | 'sr-4-bilateral-channel' | 'sr-5-cross-chain-settlement';
...
export interface BundleRequirement {
    ...
    verificationRecipes: Record<ClaimRef['scheme'], string>;
}
