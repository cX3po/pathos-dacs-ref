...
The tested binary is a local build of the hardened source. The unchanged published `@pathos-labs/dacs-verifier@0.1.0` must not be presented as containing this policy correction; a future package version would be required for a published-package claim. No package publication is part of this packet.
