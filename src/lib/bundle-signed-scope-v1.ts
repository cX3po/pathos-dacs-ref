 ...
 */
export function bundleSignedScopeHashV1(bundle: Record<string, unknown>): string {
  const { signatures: _omitSigs, anchoredByRole: _omitRole, ...scope } =
    bundle as { signatures?: unknown; anchoredByRole?: unknown };
