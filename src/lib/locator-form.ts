...
export function isLogicalLocator(value: unknown): value is string {
...
export function isNativeLocator(value: unknown): value is string {
...
export function sdkProgramName(logicalAddress: string): string {
...
export function ownerAddressOfClaim(claim: unknown): string | null {
